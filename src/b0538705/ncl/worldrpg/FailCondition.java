...
public class FailCondition  implements Runnable{
	...
	public FailCondition( int miliseconds)
	{
	...
	public void run() {
		...
		while(!satisfied)
		{
			...
			synchronized(this)
			{
				...
				try {
					Class conditionClass = Class.forName("b0538705.ncl.worldrpg.FailCondition");
	...
	public void showFailScreen()
	{
		...
		Support.currentActivity.runOnUiThread(new Runnable() {
			public void run() {
				...
				dialog.setTitle("Sorry, you have failed the scenario!");
				dialog.show();
			}
		});
	}
	...
	/*
	 *fail condition if there is more than a specified number of infected agents
	 */
	public void failIfMoreInfectedThan(Integer limit)
	{
